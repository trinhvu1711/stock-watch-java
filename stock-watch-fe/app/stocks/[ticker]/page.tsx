                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1">
                      ...
                      <li>52 Week High: ${stock.high52}</li>
                      <li>52 Week Low: ${stock.low52}</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1">
                      ...
                      <li>Avg. Volume: {stock.avgVolume}</li>
                    ...
                    <div className="space-y-2">
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span>{stock.keyRatios.profitMargin}%</span>
                        </div>
                        <Progress
                          value={stock.keyRatios.profitMargin}
                          className="h-2"
                        />
                      </div>
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span>{stock.keyRatios.returnOnEquity}%</span>
                        </div>
                        <Progress
                          value={stock.keyRatios.returnOnEquity}
                          className="h-2"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div>
                        <div className="flex justify-between  mb-1">
                          ...
                          <span>{stock.keyRatios.debtToEquity}</span>
                        </div>
                        <Progress
                          value={stock.keyRatios.debtToEquity * 100}
                          className="h-2"
                        />
                      </div>
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span>{stock.keyRatios.currentRatio}</span>
                        </div>
                        <Progress
                          value={stock.keyRatios.currentRatio * 50}
                          className="h-2"
                        />
                      </div>
                    </div>
            ...
            <Card className="mt-8">
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {stock.analystRecommendations.map((rec, index) => (
                      <TableRow key={index}>
            ...
            <Card className="mt-8">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={stock.sectorPerformance}>
                    <XAxis dataKey="name" />
                    <YAxis />
                    <Tooltip />
